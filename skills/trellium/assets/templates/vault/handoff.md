...
line is allowed when it carries an observation time and is marked as
historical.
...
- Blockers: replace with blockers, or none.
- Next best action: replace with the next best action.
- Files to read first: replace with the files to open before acting.
- Environment snapshot (optional, observed 2026-01-01 14:00, historical): replace or delete this line.
