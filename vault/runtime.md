...
| TASK-0012 | Preserve code-comment and API-documentation knowledge through a one-hop, profile-aware project rule without growing Vault. | ready_for_review | R1 direct routing and 2026.09.7 profile-aware policy are implemented; 136 tests and all local gates pass, structured review APPROVE. Await owner acceptance; do not push or publish yet. |
...
- TASK-0012: ready_for_review 2026-09-16 — R1 direct routing selected by preregistered structural ablation (254 unconditional bytes vs R0 4,562); 2026.09.7 implementation adds explicit multi-profile/root selection, one project-owned comment policy, schema-2 upgrade metadata, and zero-silent-overwrite proposals. Structured review closed 2 P1 fail-closed issues; 136 tests and local gates pass. Await owner acceptance; no push/tag/Release authorized.
